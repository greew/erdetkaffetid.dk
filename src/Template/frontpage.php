...
<head>
    ...
    <meta property="og:description" content="Har du lyst til en rigtig god kop kaffe, men ved ikke helt om det er det rigtige tidspunkt til kaffe? Tjek det her på 'Er det kaffetid?'" />
...
<section id="info" class="popup">
    ...
    <p>Dette er et lille hobbyprojekt lavet af en kaffeglad mand, nemlig jeg <a href="https://greew.dk/" target="_new">Jesper</a>.</p>
    <p>Send siden rundt, som du har lyst til!</p>
    <p>
        <a href="https://twitter.com/share" class="twitter-share-button fRight" data-text="Er du kaffetørstig, men ved ikke om du bør drikke kaffe nu? Check" data-related="greew" data-lang="da" data-size="normal">Tweet</a>
        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
    </p>
    <div class="fb-like" data-href="http://erdetkaffetid.dk" data-send="false" data-width="350" data-show-faces="false" data-font="lucida grande"></div>
    <div id="fb-root"></div>
    ...
    <p>Billedet har jeg taget selv, teksten er forfattet af undertegnede og koden er skrevet selv, dog med hjælp fra tredjepartsbiblioteker. Oversat: Alt der ligger PÅ dette domæne er mit, og jeg giver dig hermed ret til at kopiere det og bruge det, som du har lyst til.</p>
